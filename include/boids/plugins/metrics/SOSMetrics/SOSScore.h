...
#ifndef INCLUDE_SCRIMMAGE_PLUGINS_METRICS_SOSMetrics_SOSScore_H_
#define INCLUDE_SCRIMMAGE_PLUGINS_METRICS_SOSMetrics_SOSScore_H_
...
#endif // INCLUDE_SCRIMMAGE_PLUGINS_METRICS_SOSMetrics_SOSScore_H_
