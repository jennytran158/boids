...
#ifndef INCLUDE_BOIDS_PLUGINS_AUTONOMY_ATTACKERS_ATTACKERS_H_
#define INCLUDE_BOIDS_PLUGINS_AUTONOMY_ATTACKERS_ATTACKERS_H_
...
namespace scrimmage {
namespace autonomy {
class Attackers : public scrimmage::Autonomy {
 public:
...
#endif // INCLUDE_BOIDS_PLUGINS_AUTONOMY_ATTACKERS_ATTACKERS_H_
