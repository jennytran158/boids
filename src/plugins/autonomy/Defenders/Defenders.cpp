...
namespace autonomy {
  ...
  void Defenders::animate_FOV(double sense_range,double fov_width_angle, double fov_height_angle) {
  ...
  std::vector<ID> Defenders::get_neighbors_in_range(double range) {
...
void Defenders::update_desired_state(Eigen::Vector3d &v) {
...
void Defenders::check_attack(double t, double dt) {
int id = follow_id_;
